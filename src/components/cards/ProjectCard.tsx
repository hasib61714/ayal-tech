...
export function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden hover:-translate-y-2 hover:scale-[1.02] hover:border-blue-500/40 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 ease-in-out will-change-transform"
    >
      {/* Top accent */}
